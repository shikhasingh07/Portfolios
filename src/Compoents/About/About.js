      ...
      <main >
        <section className="section__mainCon " id='data__mainScreen'>
          <div className="m-auto main__con pt-2">
            ...
            <h3 className="heading__h"> <Typewriter
              onInit={(typewriter) => {
                typewriter
              ...
              <div className="inner">
                <div className="about__StyledText-sc-1ownso9-1 kNIdQM">
                  <div className='paaraa___heading'>
                    <p>
                      Hello! My name is Shikha . My interest in web development started
                      back in 2021 .Now i am Software engineer for 1.6
                      year working as a front developer in the recent company, designing
                      and transforming layout in the actual part of a working website.
                    </p>
                    <p>
